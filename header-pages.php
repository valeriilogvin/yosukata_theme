<!DOCTYPE html>
<html lang="en-HK" itemscope itemtype="https://schema.org/WebSite">
<head>
    ...
    <link rel="alternate" href="https://yosukata.com/" hreflang="en-HK">
    <!-- Web&Apps Development https://whale.com.ua/ -->

    <link rel="canonical" href="https://yosukata.com/" />

    <!-- Schema website url -->
    <link itemprop="url" href="https://yosukata.com/" />

    <!-- Open Graph -->
    <meta property="og:title" content="yosukata.com" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="en" />
    <meta property="og:url" content="<?php echo "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];?>" />
    <meta property="og:site_name" content="yosukata.com" />

    <!-- Open Graph | Share img -->
    <meta property="og:image" content="<?php echo get_stylesheet_directory_uri() ?>/img/share_img.jpg" />
    <meta property="og:image:url" content="<?php echo get_stylesheet_directory_uri() ?>/img/share_img.jpg" />
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-7RBL6KLBEC"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'G-7RBL6KLBEC');
	</script>

    <!-- Clarity tracking code for https://yosukata.com/ -->
	<script>
	    (function(c,l,a,r,i,t,y){
	        c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};
	        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;
	        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);
	    })(window, document, "clarity", "script", "4jrk90shz8");
	</script>
